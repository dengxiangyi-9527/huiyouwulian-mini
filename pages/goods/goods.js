...
Page({
  ...
  onShareAppMessage: function() {
    let that = this;
    let _inviteCode = wx.getStorageSync('inviteCode');
    if (!_inviteCode){
      that.getInviteCode();
      _inviteCode = wx.getStorageSync('inviteCode');
    }
    return {
      title: that.data.goods.name,
      desc: '喝好水,找慧优物联!',
      path: '/pages/index/index?goodId=' + this.data.id + '&inviteCode=' + _inviteCode,
  ...
  getInviteCode: function () {
    let that = this;
    util.request(api.GetInviteCode, {
