...
Page({
    ...
    util.request(api.CartCheckout, {
      ...
      if (res.code === 0) {
        that.setData({
          ...
          goodsAreaCode:res.data.checkedGoodsList[0].areaCode,
          // addressAreaCode:res.data.checkedAddress.areaCode,
  ...
  selectAddress() {
    ...
    wx.navigateTo({
      url: '/pages/ucenter/address/address?code='+code,
    })
  },
  selectCoupon() {
    wx.navigateTo({
